...
import puneeth from '@salesforce/resourceUrl/puneeth';

export const SOCIAL_DATA = [
    {
        type: 'twitter',
        label: 'twitter/punee83',
        link : 'https://twitter.com/punee83',
        icon : SOCIAL+'/SOCIAL/twitter.svg'

    },
    {
        type: 'github',
        label: 'github/puneethvb',
        link : 'https://github.com/puneethvb',
        icon : SOCIAL+'/SOCIAL/github.svg'

    },
    {
        type: 'linkedin',
        label: 'linkedin/puneeth-bharath',
        link : 'https://www.linkedin.com/in/puneeth-bharath-2a328782',
        icon : SOCIAL+'/SOCIAL/linkedin.svg'

    },
    {
        type: 'trailhead',
        label: 'trailhead/puneeth-bharath',
        link : 'https://trailblazer.me/id/pbharath',
...
export const USER_DETAILS  = {
    ...
    name : 'Puneeth V Bharath',
    role : 'Salesforce Architect',
    email : 'puneethvb@gmail.com',
    phone : '9632437373'
};

export const IMAGE = puneeth;
